...
export default function CoffeeForm(props) {
    ...
    async function handleSubmitForm() {
        ...
        // define a guard clause that only submits form if its completed
        if (!selectedCoffee) { return }

        try {
            // then create a new Obj 
            const newGlobalData = {
                ...(globalData || {})
            }
            ...
            // add the data to the firebase firestore
    ...
    return (
        ...
        (<Modal handleCloseModal={() => setShowModal(false)}>
            ...
            }} type='number' value={coffeeCost} placeholder='4.50' />
